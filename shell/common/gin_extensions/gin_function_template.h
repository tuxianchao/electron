...
// #ifndef gin_gin_FUNCTION_TEMPLATE_H_
// #define gin_gin_FUNCTION_TEMPLATE_H_
...
// // CallbackHolder and CallbackHolderBase are used to pass a base::Callback
// from
// // CreateFunctionTemplate through v8 (via v8::FunctionTemplate) to
// // DispatchToCallback, where it is invoked.

// // This simple base class is used so that we can share a single object
// template
...
//   // In C++, you can declare the function foo(void), but you can't pass a
//   void
...
// // object template that forwards to a provided C++ function or
// base::Callback. template <typename Sig> void
// CreateFunctionHandler(v8::Isolate* isolate,
...
// #endif  // gin_gin_FUNCTION_TEMPLATE_H_
