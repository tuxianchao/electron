...
v8::Local<v8::Value> V8ValueConverter::ToV8Object(
  ...
  // result.SetHidden("simple", true); // TODO(deermichel): restore this
  ...
  return gin::ConvertToV8(result.isolate(),
                          result);  // TODO(deermichel): correct?
}
...
v8::Local<v8::Value> V8ValueConverter::ToArrayBuffer(
  ...
  //     !buffer_value->IsFunction()) { // TODO(deermichel): restore this
  if (!buffer_value->IsFunction()) {
