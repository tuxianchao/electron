...
ipcMainUtils.handleAsync('CHROME_RUNTIME_SEND_MESSAGE', async function (event, extensionId, message) {
  if (isBackgroundPage(event.sender)) {
...
ipcMainUtils.handleAsync('CHROME_TABS_SEND_MESSAGE', async function (event, tabId, extensionId, message) {
...
ipcMainUtils.handleAsync('CHROME_GET_MESSAGES', async function (event, extensionId) {
...
ipcMainUtils.handleAsync('CHROME_STORAGE_READ', async function (event, storageType, extensionId) {
...
ipcMainUtils.handleAsync('CHROME_STORAGE_WRITE', async function (event, storageType, extensionId, data) {
  const filePath = getChromeStoragePath(storageType, extensionId)
...
ipcMainUtils.handleAsync('CHROME_TABS_EXECUTE_SCRIPT', async function (event, tabId, extensionId, details) {
