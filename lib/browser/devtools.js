...
ipcMainUtils.handleAsync('ELECTRON_INSPECTOR_CONTEXT_MENU', async (event, items, isEditMenu) => {
...
ipcMainUtils.handleAsync('ELECTRON_INSPECTOR_SELECT_FILE', async function (event) {
...
ipcMainUtils.handleAsync('ELECTRON_INSPECTOR_CONFIRM', async function (event, message = '', title = '') {
