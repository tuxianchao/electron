...
if (features.isDesktopCapturerEnabled()) {
  ...
  ipcMainUtils.handleAsync('ELECTRON_BROWSER_DESKTOP_CAPTURER_GET_SOURCES', async (event, ...args) => {
...
ipcMainUtils.handleAsync('ELECTRON_BROWSER_SANDBOX_LOAD', async function (event) {
  const preloadPaths = [
